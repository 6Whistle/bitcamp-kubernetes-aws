...
import { deleteUserAPI, existByUsernameAPI, findAllUsersAPI, findUserByIdAPI, findUsersCountAPI, loginAPI, modifyUserAPI } from "./user-api";
...
export const existByUsername:any = createAsyncThunk('users/existByUsername', async (username:string) => existByUsernameAPI(username))